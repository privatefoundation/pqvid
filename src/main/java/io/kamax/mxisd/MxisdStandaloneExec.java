    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (argsIt.hasNext()) {
                ...
                switch (arg) {
                    ...
                    case "--usage":
                        ...
                        System.out.println("  --dump           Dump the full pqvid configuration");
                        System.out.println("  --dump-and-exit  Dump the full pqvid configuration and exit");
                        System.out.println(" ");
                        System.exit(0);
                        return;
                    case "-v":
            ...
            if (Objects.isNull(cfg)) {
                cfg = YamlConfigLoader.tryLoadFromFile("pqvid.yaml").orElseGet(MxisdConfig::new);
            }
