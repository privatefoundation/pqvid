...
public class RestBackendConfig {
    ...
    public static class IdentityEndpoints {
        ...
        private String single = "/_pqvid/backend/api/v1/identity/single";
        private String bulk = "/_pqvid/backend/api/v1/identity/bulk";
    ...
    public static class ProfileEndpoints {
        ...
        private String displayName = "/_pqvid/backend/api/v1/profile/displayName";
        private String threepids = "/_pqvid/backend/api/v1/profile/threepids";
        private String roles = "/_pqvid/backend/api/v1/profile/roles";
    ...
    public static class Endpoints {
        ...
        private String auth = "/_pqvid/backend/api/v1/auth/login";
        private String directory = "/_pqvid/backend/api/v1/directory/user/search";
